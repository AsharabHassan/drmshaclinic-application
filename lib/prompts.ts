...
- A TRUE HOLLOW — lost fat-pad volume under the eye → Veluria does NOT fill this. It is structural. Say so honestly and note the doctor will advise at the consultation.
...
- moles, skin tags or any suspicious lesion (always a matter for the doctor, never cosmetic)
- deeply pitted "ice-pick" scarring (may need resurfacing alongside a booster)
When you observe one of these, flag it honestly and say the doctor will advise at the consultation. NEVER name or recommend any other product, brand, device, injectable, laser, peel or procedure — those are strictly for the consultation.
...
`
  ...
  return `Photorealistic clinical follow-up photograph of the SAME person in the first image, at the END POINT of their COMPLETE Veluria programme at Dr.M.Sha Wellness and Aesthetics Clinic — every course finished, every product below delivered by microneedling, and the collagen laid down by the recombinant collagenase fully remodelled. This is the best this person's skin gets: not a first session, not a halfway point, but the finished result.
